...
<body>
  ...
  <div class="ui sidebar vertical left menu overlay visible" style="-webkit-transition-duration: 0.1s; overflow: visible !important; background-color:rgb(255, 184, 76);">
  <div class="item logo">
    <img src="storage/Logo_SOS_Button.png" />
<img src="storage/Logo_SOS_Button.png" style="display: none" />
  </div>
...
<div class="pusher">
  <div class="ui menu asd col-md-10" style="border-radius: 0!important; border: 0;  margin-left: 260px; -webkit-transition-duration: 0.1s; position:fixed">
 ...
 <button id="myBtn" class=" enter btn btn-outline-primary">Login</button>
...
<script src='https://cdnjs.cloudflare.com/ajax/libs/semantic-ui/2.2.4/semantic.js'></script>
    ...
    <script src="js/bolinhas.js"></script>
